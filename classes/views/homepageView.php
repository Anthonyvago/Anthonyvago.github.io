    ...
    <div class="reviews-container">
        <div class="reviews-sub-container">
            ...
            <div class="gemiddelde-rating-container col-12">
                ...
                <div class="body">
                    <?php
                    echo '<p>' . number_format($gemRating, 2) . ' / 5.00</p>';
                ...
                <?php foreach ($googleReviews as $googleReview) { ?>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="review">
                                ...
                                <div class="naam-en-sterren-container">
                                    ...
                                    <div class="row">
                                        ...
                                        for ($starNr = 0; $starNr < $nrOfMaxStars; $starNr++) {
                                            ...
                                            if ($drawStar): echo 'class="bi bi-star-fill"'; endif;
                                            if (!$drawStar): echo 'class="bi bi-star"'; endif;
                                            echo 'fill="rgb(18, 49, 100)" xmlns="http://www.w3.org/2000/svg">';
                                            if ($drawStar) {
                            ...
                            <?php }
                            echo '<p class="datum text-right">' . getTimeDiffToString($googleReview['date']) . '</p>';
                            echo '<p class="datum text-right">' . getDateToText($googleReview['date']) . '</p>';
                            ?>
                        </div>
                    </div>
                <?php } ?>
